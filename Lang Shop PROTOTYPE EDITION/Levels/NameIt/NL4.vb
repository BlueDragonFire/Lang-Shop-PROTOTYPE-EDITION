Public Class NL4
    ...
    Private Sub NL4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If GlobalVariables.LearnLang = 0 Then 'Afrikaans
            ...
            btnWrong1.Text = words.Anames(4)
            btnWrong2.Text = words.Anames(1)
            btnRight.Text = words.Anames(3)
        ...
        ElseIf GlobalVariables.LearnLang = 1 Then 'English
            ...
            btnWrong1.Text = words.Enames(4)
            btnWrong2.Text = words.Enames(1)
            btnRight.Text = words.Enames(3)
        ...
        ElseIf GlobalVariables.LearnLang = 2 Then 'Zulu
            ...
            btnWrong1.Text = words.Znames(4)
            btnWrong2.Text = words.Znames(1)
            btnRight.Text = words.Znames(3)
